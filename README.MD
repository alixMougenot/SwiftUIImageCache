...
#### Include the module
You can drag and drop the **ImageCache** folder and target from the Project to your own. Don't forget to add the **ImageCache.framework** to *Included Binaries* so that it gets shipped with the App.
